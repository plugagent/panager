...
class _ScheduleCreateInputLegacy(BaseModel):
    message: str
    trigger_at: str  # ISO 8601 형식
    user_id: int


class _ScheduleCancelInputLegacy(BaseModel):
    schedule_id: str
    user_id: int


@tool(args_schema=_ScheduleCreateInputLegacy)
...
@tool(args_schema=_ScheduleCancelInputLegacy)
